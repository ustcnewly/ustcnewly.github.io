...
class MyListCtrl(wx.ListCtrl):
    def __init__(self, parent, id):
        ...
        files = os.listdir('.')
        images = ['./img/closebtn.png', './img/closebtn.png', './img/closebtn.png', 
        './img/closebtn.png', './img/closebtn.png', './img/closebtn.png']
...
class FileHunter(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        tb.AddSimpleTool(10, wx.Bitmap('./img/closebtn.png'), 'Previous')
        tb.AddSimpleTool(20, wx.Bitmap('./img/closebtn.png'), 'Up one directory')
        tb.AddSimpleTool(30, wx.Bitmap('./img/closebtn.png'), 'Home')
        tb.AddSimpleTool(40, wx.Bitmap('./img/closebtn.png'), 'Refresh')
        tb.AddSeparator()
        tb.AddSimpleTool(50, wx.Bitmap('./img/closebtn.png'), 'Editor')
        tb.AddSimpleTool(60, wx.Bitmap('./img/closebtn.png'), 'Terminal')
        tb.AddSeparator()
        tb.AddSimpleTool(70, wx.Bitmap('./img/closebtn.png'), 'Help')
        tb.Realize()
