...
class Newt(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        toolbar1.AddLabelTool(-1, '', wx.Bitmap('./img/closebtn.png'))
        toolbar1.AddLabelTool(-1, '', wx.Bitmap('./img/closebtn.png'))
        toolbar1.AddLabelTool(-1, '', wx.Bitmap('./img/closebtn.png'))
        ...
        bold = wx.Bitmap('./img/closebtn.png')
        toolbar2.AddCheckTool(-1, bold)
        italic = wx.Bitmap('./img/closebtn.png')
        toolbar2.AddCheckTool(-1, italic)
        under = wx.Bitmap('./img/closebtn.png')
        toolbar2.AddCheckTool(-1, under)
        toolbar2.AddSeparator()
        toolbar2.AddLabelTool(-1, '', wx.Bitmap('./img/closebtn.png'))
        toolbar2.AddLabelTool(-1, '', wx.Bitmap('./img/closebtn.png'))
        toolbar2.AddLabelTool(-1, '', wx.Bitmap('./img/closebtn.png'))
