...
class Example(wx.Frame):
    ...
    def InitUI(self):   
        ...
        pause = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('.\img\closebtn.png'))
        play  = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('.\img\closebtn.png'))
        forw  = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('.\img\closebtn.png'))
        back  = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('.\img\closebtn.png'))
        vol = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('.\img\closebtn.png'))
