...
bitmapDir = os.path.join(dirName, './img')
 
class MyFrame(wx.Frame):
 
    #----------------------------------------------------------------------
    def __init__(self, mplayer, parent=None, idx=-1, title="wxpython player"):
...
app = wx.App()
frame = MyFrame(mplayer='./Mplayer/mplayer.exe')
frame.Show()
app.MainLoop()